...
from replacing.constants import WARMUP_STEPS
...
from replacing.input_settings.solver_configs import SGSPConfig
...
class BurgersSGSP(BurgersBase):
    ...
    def run_simulation(self) -> None:
        ...
        try:
            ...
            with self.timer("total_simulation"):
                ...
                if not blowup_detected and self.requested_snapshots is not None:
    ...
    def _write_blowup_solutions_to_csv(self) -> None:
        ...
        if not self.requested_snapshots:
            print(
