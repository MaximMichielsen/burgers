...
def create_velocity_plot_configs(
    ...
    # Load solution AND its corresponding spatial mesh from the CSV directory
    dns_solution, dns_mesh = read_data(directory=paths.dns_data, final_only=True)
    ...
    base_configs: list[VelocityPlotConfig] = [
        ...
        VelocityPlotConfig(
            data_path=paths.dns_forcing,
            label="LES - no_model forcing",
            color="lime",
            linestyle="--",
            marker="d",
            mesh=disc_cfg.mesh_les,
